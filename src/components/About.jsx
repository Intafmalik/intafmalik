                    ...
                    <div
                        ...
                        <div className='w-full md:w-2/5  '>
                            <div className=' flex items-center justify-center p-2' >
                                <img src={aboutImg} width={250} alt='about image' className='rounded-2xl object-cover w-[75%] h-[75%] border hover:border-primary-color hover:shadow-[0_0px_15px_-1px_#02ff02] brightness-50 hover:brightness-100 focus:brightness-100 active:brightness-100 transition ease-in-out duration-300' />
                            </div>
                        </div>
